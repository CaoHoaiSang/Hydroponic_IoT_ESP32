...
function buildQualityFields(payload, calibration, stability, control) {
  return {
    ...
    ecProbePowerMode: payload.ecProbePowerMode ?? 'continuous_legacy',
    ecProbePowered: payload.ecProbePowered ?? null,
    ecProbeState: payload.ecProbeState ?? null,
    ecProbeWarmupMs: payload.ecProbeWarmupMs ?? null,
    ecProbePoweredAtUptimeMs: payload.ecProbePoweredAtUptimeMs ?? null,
    ecProbeMeasurementTrigger: payload.ecProbeMeasurementTrigger ?? null,
