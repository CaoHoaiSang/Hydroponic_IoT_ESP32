...
// Legacy payloads remain bound to the original full-window threshold.
const TDS_WINDOW_MAX_SPREAD_RAW = 50;
const TDS_WINDOW_TRIM_COUNT_PER_SIDE = 3;
const TDS_WINDOW_TRIMMED_SAMPLE_COUNT = 24;
const TDS_WINDOW_MAX_ROBUST_SPREAD_RAW = 50;
const TDS_WINDOW_MAX_ABSOLUTE_SPREAD_RAW = 80;
...
module.exports = {
  ...
  TDS_WINDOW_TRIM_COUNT_PER_SIDE,
